    ...
    try {
      ...
      if (stored) {
        ...
        const defaultClients = [
          ...
          {
            id: "2",
            clientName: "Digital Connect Pvt Ltd",
            amount: "3500",
            date: "2025-10-30",
            clientProfile:
      ...
      console.log("Error loading WhatsApp clients:", error);
    }
  };
  ...
  return (
    <SafeAreaView style={styles.container}>
      ...
      <View style={styles.header}>
        ...
        <Text style={styles.headerTitle}>WhatsApp Bulk SMS</Text>
      ...
      <FlatList
        ...
        ListEmptyComponent={
          <View style={styles.emptyContainer}>
            ...
            <Text style={styles.emptyText}>No WhatsApp clients available</Text>
          </View>
        }
